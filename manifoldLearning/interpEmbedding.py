...
plt.title('3D Multidim. Scailing Embedding')
subpl.view_init(42, 101) #looks good when njobs=-1
subpl.view_init(-130,-33)#looks good when njobs=1
subpl.set_xlabel('x($\mu$,$\sigma$)')
subpl.set_ylabel('y($\mu$,$\sigma$)')
subpl.set_zlabel('z($\mu$,$\sigma$)')
subpl.set_zticks([])
frame1 = plt.gca()
...
subpl2.set_xlabel('mean $\mu$')
subpl2.set_ylabel('std. dev. $\sigma$')
subpl2.set_zlabel('x($\mu$,$\sigma$)')
subpl2.set_zticks([])
frame1 = plt.gca()
frame1.axes.get_xaxis().set_ticks([])
frame1.axes.get_yaxis().set_ticks([])
...
subpl3.set_xlabel('mean $\mu$')
subpl3.set_ylabel('std. dev. $\sigma$')
subpl3.set_zlabel('y($\mu$,$\sigma$)')
subpl3.set_zticks([])
frame1 = plt.gca()
frame1.axes.get_xaxis().set_ticks([])
frame1.axes.get_yaxis().set_ticks([])
...
subpl4.set_xlabel('mean $\mu$')
subpl4.set_ylabel('std. dev. $\sigma$')
subpl4.set_zlabel('z($\mu$,$\sigma$)')
subpl4.set_zticks([])
frame1 = plt.gca()
frame1.axes.get_xaxis().set_ticks([])
frame1.axes.get_yaxis().set_ticks([])
...
subpl2.set_xlabel('x($\mu$,$\sigma$)')
subpl2.set_ylabel('y($\mu$,$\sigma$)')
frame1 = plt.gca()
frame1.axes.get_xaxis().set_ticks([])
frame1.axes.get_yaxis().set_ticks([])
plt.axis('tight')
...
subpl2.scatter(embed2d_inv_predx, embed2d_inv_predy,s=10, c=colors)
plt.title('Inverse of Embedding')
subpl2.set_xlabel('$\mu(x,y)$')
subpl2.set_ylabel('$\sigma(x,y)$')
frame1 = plt.gca()
frame1.axes.get_xaxis().set_ticks([])
frame1.axes.get_yaxis().set_ticks([])
plt.axis('tight')
